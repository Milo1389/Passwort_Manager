...
# Master Passwort
# Zuers twird von dem Benutzer befohlen ein Masterpasswort zu erstellen
# nach der Erstellung wird nach dem Masterpasswort wieder gefragt
# Falls der Nutzer die korrekte Eingabe tätigt, werden Ihm die 5 verfügbaren Möglichkeiten zur Auswahl gelegt
